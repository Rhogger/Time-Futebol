...
export default class Meia extends Jogador implements IJogadores {
	public static numIntancias: number = 0
	public static numTentativas: number = 0
	public static readonly MINIMO: number = 4
	...
	constructor(jogador: IJogadores) {
		...
		try {
			if (Meia.numIntancias < Meia.LIMITE) {
				Meia.numIntancias++
			} else {
				throw new Error('!!!FALHA NO CADASTRO!!!\n\nLimite de Meias excedido.')
			}
		} catch (erro) {
